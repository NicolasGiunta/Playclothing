...
const productsAPIController = {
    ...
    products: async (req, res) => {
        ...
        await Promise
        .all([productos, tipos, categorias])
        .then(([productos, tipos, categorias]) => {
            ...
            let sumaTipos = tipos.length
            let sumaCategorias = categorias.length
            ...
            return res.status(400).json({
                ...
                totalTipos: sumaTipos,
                totalCategorias: sumaCategorias,
                data: productos
            })
        })
