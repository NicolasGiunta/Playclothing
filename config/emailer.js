...
const sendMail = async(email) => {
    ...
    const info = await transporter.sendMail({
        ...
        attachments: [
          {
          filename: 'prueba.png',
          path: "K:/pendrive/DH ejercicios/grupo_4_Playclothing/public/image/logo.jpg",
